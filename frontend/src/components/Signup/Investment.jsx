    ...
    <div className="mt-20 flex flex-col items-center mb-20">
      ...
      <div className="grid grid-cols-2 gap-10 mb-8 m-auto">
        <div className="flex items-center gap-8">
          <img src={assets.acopBenefits} alt="" className="w-40" />
          <div className="">
            <h3 className="text-2xl mb-2">Stocks</h3>
            <p>Invest in all exchange-listed securities</p>
          </div>
        </div>
        <div className="flex items-center gap-8">
          <img src={assets.mfAcop} alt="" className="w-40" />
          <div>
            <h3 className="text-2xl mb-2">Mutual funds</h3>
            <p>Invest in commission-free direct mutual funds</p>
          </div>
        </div>
        <div className="flex items-center gap-8">
          <img src={assets.ipoAcop} alt="" className="w-40" />
          <div>
            <h3 className="text-2xl mb-2">IPO</h3>
            <p>Apply to the latest IPOs instantly via UPI</p>
          </div>
        </div>
        <div className="flex items-center gap-8">
          <img src={assets.foAcop} alt="" className="w-40" />
          <div>
            <h3 className="text-2xl mb-2">Futures & options</h3>
